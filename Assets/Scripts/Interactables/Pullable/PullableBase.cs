// Assets/Scripts/Interactable/PullableBase/PullableBase.cs
using System;
using UnityEngine;
using DG.Tweening;
...
namespace IT.Interactables.Pullable
{
    ...
    public abstract class PullableBase : Interactable, IDependencySource<float>
    {
        public override InteractionType Kind => InteractionType.Pull;
        ...
        [SerializeField] protected MovementOverlap handleCheck;
        ...
        protected virtual void Awake()
        {
            ...
            if (handleCheck == null) handleCheck = GetComponentInChildren<MovementOverlap>();
            DrawLine();
        }
