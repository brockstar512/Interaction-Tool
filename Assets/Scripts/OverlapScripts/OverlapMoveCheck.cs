...
namespace Player.ItemOverlap
{
    public class OverlapMoveCheck : OverlapObjectCheck,IDoesOverlapLayer
    {
        ...
        {
           //if you are the player and you are interacting with a moving object.
           //ignore the item you are interacting with and the player
        ...
        public bool DoesOverlap(Vector2 itemLocation)
        {
            ...
            //Debug.Log("THIS IS OVERLAPPING at " + overlappingCols.Length);
