// Assets/Scripts/Interface/InterfaceRefDrawer.cs
using System;
...
namespace IT.Editor
{
    ...
    public class InterfaceRefDrawer : PropertyDrawer
    {
        ...
        // Walks past List<>/array wrappers to find InterfaceRef<TInterface>,
        ...
        private static Type GetInterfaceType(Type fieldType)
        {
            ...
            if (t != null && t.IsGenericType &&
                t.GetGenericTypeDefinition() == typeof(InterfaceRef<>))
